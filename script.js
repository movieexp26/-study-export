    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "type": "text",
          "title": "謝礼について",
          "content": "本実験に参加していただくにあたり、謝礼として100円分のAmazon e-Giftをお送りします。実験終了後、Amazon e-Giftを送付するためのメールアドレスをご記入いただきます。"
        },
        {
          "required": true,
          "type": "text",
        ...
        },
        {
          ...
          "type": "text",
          "title": "個人情報の取り扱い",
          "content": "本実験・調査では、謝礼としてAmazon e-Giftを送付するため、実験終了後にメールアドレスをご入力いただきます。ご入力いただいたメールアドレスは謝礼送付の目的にのみ使用します。また、研究結果の分析・公表にあたっては、メールアドレスなど個人を特定できる情報を公表することはありません。"
        },
        {
          "required": true,
          "type": "text",
...
this.state.condition = (id % 3) +1;
    ...
    },
    {
      ...
      "items": [
        {
          "type": "text",
          "content": "ご自身の映画鑑賞経験に関して、以下の質問文を読んでいただき、あなたにもっとも当てはまると思う選択肢を選んで回答してください。回答は選択肢のボタンをチェックすることで行ってください。"
        },
        {
          "required": true,
          "type": "radio",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "required": true,
          "type": "radio",
          "label": "今の説明を読む前の時点で、この実験が「作品名の表示タイミングが、視聴者の感情や予告編への評価、映画本編の視聴意欲などに与える影響」を調べるものであることに、どの程度気づいていましたか。",
          "options": [
            {
              "coding": "1",
              "label": "まったく気づいていなかった"
      ...
      "items": [
        {
          "required": true,
          "type": "input",
          "label": "実験にご協力いただき誠にありがとうございました。以下に謝礼を送付するためのEメールアドレスをご記入ください。",
          "attributes": {
            "type": "email"
          },
          "help": "本実験において提供されたEメールアドレスは、謝礼を送付する際にのみ使用します。第三者への提供やその他の目的のために利用することはありません。",
          "name": "email_address"
        }
      ],
      "scrollTop": true,
